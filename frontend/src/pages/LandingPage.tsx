...
const LandingPage: React.FC = () => {
    ...
    const handleRecommendations = async () => {
        if (csvUploaded && userInfoSubmitted && transactionData.length > 0 && userJSON) {
            try {
                ...
                const response = await axios.post(`${API_BASE_URL}/api/recommendations`, requestData, {
                    headers: {
                ...
                <div className="relative">
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        ...
                        <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-6 rounded-2xl">
                            <div
                                className="aspect-video bg-gradient-to-br from-slate-800 to-slate-800 rounded-xl p-4 text-white">
